...
use common\model\gr_chat\BatchBlock;

class BatchBlockSqlServer extends BaseSqlServer
{
    ...
    public static function insertBatchBlock($data)
    {
        $sql = "insert into gr_batch_block(`gkey`,`role_id`,`server_id`,`add_time`,`expect_unblock_time`,`ban_time`,`type`,`op_admin`)values";
        $sql .= "('{$data['gkey']}',".
            "'{$data['roleid']}',".
            "'{$data['sid']}',".
            "{$data['add_time']},".
            "{$data['expect_unblock_time']},".
            "{$data['ban_time']},".
            "{$data['type']},".
            "'{$data['op_admin']}')";
