...
class RoleNameBlock extends Oauth
{
...
//    const JIU_ZHOU_GAME = 'jzxjz';
    ...
    public function blockUser()
    {
        ...
        $data['status'] = $this->request->post('type/s',  RoleNameBlockServer::STATUS_BLOCK);

        $data['block_time'] = $this->request->post('block_time/d',  RoleNameBlockServer::BLOCK_TIME);//默认封禁1年
        $data['admin_user'] = $this->user_data['username'];
        $data['op_ip']      =  $this->user_data["last_ip"];

        $res = RoleNameBlockServer::block($data);
    ...
    public function blockChat()
    {
        ...
        $data['status'] = $this->request->post('type', RoleNameBlockServer::STATUS_BLOCK);

        $data['block_time'] = $this->request->post('block_time/d',RoleNameBlockServer::CHAT_TIME);//默认封禁1年
        $data['admin_user'] = $this->user_data['username'];
        $data['op_ip']      = $this->user_data["last_ip"];

        $res = RoleNameBlockServer::blockChat($data);
    ...
    public function unblockMixed()
    {
        ...
        $data['admin_user'] = $this->user_data['username'];
        $data['op_ip']      = $this->user_data["last_ip"];
        $res = RoleNameBlockServer::unblockMixed($data);
        return return_json($res);
    }
    ...
    public function index()
    {
        ...
        $res = RoleNameBlockServer::getList($data);
        $count = RoleNameBlockServer::getCount($data);
